...
<%
    ...
    List<EventBean> artEvents = null;
    try {
    	artEvents = eventDao.getEventsByType("Arte");
    } catch (SQLException e) {
        e.printStackTrace();
    }
    System.out.println("Events retrieved: " + artEvents.size());
%>
...
<body>
    ...
    <main>
        ...
        <h2 align="center">Mostre d'arte</h2>

        <section class="eventsSection">
            <div class="eventsContainer">
                <%
                    if (artEvents != null && !artEvents.isEmpty()) {
                        for (EventBean event : artEvents) {
                %>
                    <div class="eventCard">
