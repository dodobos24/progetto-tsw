...
<%
    ...
    List<EventBean> sportEvents = null;
    try {
    	sportEvents = eventDao.getEventsByType("Sport");
    } catch (SQLException e) {
        e.printStackTrace();
    }
    System.out.println("Events retrieved: " + sportEvents.size());
%>
