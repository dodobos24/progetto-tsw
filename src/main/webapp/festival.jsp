...
<%
    ...
    List<EventBean> festivalEvents = null;
    try {
    	festivalEvents = eventDao.getEventsByType("Festival");
    } catch (SQLException e) {
        e.printStackTrace();
    }
    System.out.println("Events retrieved: " + festivalEvents.size());
%>
...
<body>
    ...
    <main>
        ...
        <h2 align="center">Festival</h2>

        <section class="eventsSection">
            <div class="eventsContainer">
                <%
                    if (festivalEvents != null && !festivalEvents.isEmpty()) {
                        for (EventBean event : festivalEvents) {
                %>
                    <div class="eventCard">
